...
public interface ReservaDao {
     ...
     * ordenados en función de uno de sus campos (nombreCliente, numeroMovil,
     ...
     */
    @Query("SELECT * FROM Reserva ORDER BY " +
    ...
    LiveData<List<Reserva>> getOrderedReservas(String orderBy);
