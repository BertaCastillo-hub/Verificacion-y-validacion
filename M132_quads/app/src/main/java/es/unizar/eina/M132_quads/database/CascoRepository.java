 ...
 * Interacciona con la base de datos a través de las clases AppRoomDatabase y CascoDao.
 */
public class CascoRepository {
    ...
    /**
     * Constructor de CascoRepository utilizando el contexto de la aplicación para instanciar la base de datos.
     ...
     * @param casco El objeto Casco a insertar. Debe tener valores no nulos para sus claves primarias
     *              (matriculaQuad y idReserva) y un número de cascos válido.
     * @return Si el casco se ha insertado correctamente, devuelve el identificador de la fila insertada (rowId).
     *         Devuelve -1 si la operación falla (por ejemplo, por un conflicto de clave primaria o un timeout).
     */
     ...
     * @param casco El objeto Casco a actualizar, identificado por su clave primaria compuesta
     *              (matriculaQuad y idReserva).
     * @return El número de filas modificadas. Debería ser 1 si la actualización fue exitosa,
     *         0 si no se encontró ningún registro con esa clave primaria, o -1 si ocurrió un error.
     */
     ...
     * @param casco Objeto Casco que se va a eliminar. Room utilizará la clave primaria compuesta
     *              (matriculaQuad y idReserva) para encontrar el casco a borrar.
     * @return El número de filas eliminadas. Debería ser 1 si la eliminación fue exitosa,
     ...
     * Como el DAO ya devuelve LiveData, no es necesario usar el 'databaseWriteExecutor',
     * ya que Room gestiona el hilo de forma automática para las consultas @Query que
     * devuelven LiveData.
     *
     ...
     * @param nuevosCascos La lista de nuevos objetos Casco a asociar con la reserva.
     */
